 ...
 */
public class ProcessReturnCodeAnomalyException
        extends Exception {

    public static final @NotNull String CLASS_NAME = "ProcessReturnCodeAnomalyException";
     ...
     */
    public ProcessReturnCodeAnomalyException() {
        super();
    }
     ...
     */
    public ProcessReturnCodeAnomalyException( String message ) {

        new BasicOutput(
                BasicVariables.STRING_BASIC_OUTPUT_LOG_TYPE_ERROR,
                ProcessReturnCodeAnomalyException.class.getName(),
                message
        );
    }
     ...
     * @since 1.4
     */
    public ProcessReturnCodeAnomalyException( Throwable cause ) {
